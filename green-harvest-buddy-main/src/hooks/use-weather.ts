...
import { weather as mockWeather } from "@/lib/mock-data";
...
export function useWeather() {
  ...
  // Fall back to mock data if location is not set or fetch fails
  const resolved = weather ?? (location === null ? mockWeather : null);
