  ...
  return (
    <AppLayout variant="profile">
      ...
      <form onSubmit={save} className="mt-5 space-y-4">
        ...
        <Card title="🔐 Account Activity (Real-time)">
          <div className="space-y-3 text-xs sm:text-sm p-1">
            <div className="flex justify-between items-center border-b border-border/40 pb-2.5">
              <span className="text-muted-foreground font-semibold">Joined Date</span>
              <span className="font-bold text-foreground">
                {p.signup_at ? new Date(p.signup_at).toLocaleString('en-IN', {
                  dateStyle: 'medium',
                  timeStyle: 'short'
                }) : "N/A"}
              </span>
            ...
            <div className="flex justify-between items-center pt-0.5">
              <span className="text-muted-foreground font-semibold">Recent Sign-in</span>
              <span className="font-bold text-foreground">
                {p.last_sign_in_at ? new Date(p.last_sign_in_at).toLocaleString('en-IN', {
                  dateStyle: 'medium',
                  timeStyle: 'short'
                }) : "Just now"}
              </span>
