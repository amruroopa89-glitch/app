...
Provide clear, structured, step-by-step instructions or steps for the farmer's specific query (e.g. specific fertilizer recommendations, dosages, timing, pest controls, or soil type for the crop asked) using numbered lists (1, 2, 3...). Make the guidance simple, practical, and easy to follow.
${
  hasProfile
