      ...
      then(onfulfilled?: any, onrejected?: any) {
        ...
        if (table === 'government_schemes') {
          promiseResult = Promise.resolve({
            data: [
              { title: "PM-KISAN", body: "Financial benefit of Rs. 6000 per year in three equal installments to all landholding farmer families." },
              { title: "Pradhan Mantri Fasal Bima Yojana (PMFBY)", body: "Government sponsored crop insurance scheme, integrating multiple stakeholders on a single platform." },
              { title: "Soil Health Card Scheme", body: "Provides Soil Health Cards to all farmers in the country to enable them to address soil nutrient deficiencies." }
            ],
            error: null
          });
          ...
          promiseResult = Promise.resolve({
            data: [
              { icon: "🐛", title: "Pest outbreak warning", body: "Fall Armyworm detected in neighbouring districts. Inspect maize crops immediately.", state: "Andhra Pradesh" },
              { icon: "🌧️", title: "Heavy rainfall warning", body: "Monsoon showers expected to intensify over next 48 hours. Ensure proper drainage in fields.", state: null },
              { icon: "🌡️", title: "Heat wave advisory", body: "Temperatures rising above 40°C. Increase irrigation frequency for horticulture crops.", state: null }
            ],
            error: null
          });
